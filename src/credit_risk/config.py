...
PIPELINE_OVERVIEW_FIG_PATH = FIGURES_DIR / "pipeline_overview.png"
MODEL_COMPARISON_FIG_PATH = FIGURES_DIR / "model_comparison_auc.png"
DATA_QUALITY_FIG_PATH = FIGURES_DIR / "data_quality_overview.png"
